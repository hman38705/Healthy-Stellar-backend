...
export class LabReportService {
    ...
    async generateReport(templateId: string, labOrderId: string, generatedBy: string, parameters?: any): Promise<LabReport> {
        ...
        setTimeout(async () => {
            try {
                const generatedFilePath = await this.processReportGeneration(template, savedReport, parameters);
    ...
    private async processReportGeneration(template: LabReportTemplate, report: LabReport, parameters: any): Promise<string> {
