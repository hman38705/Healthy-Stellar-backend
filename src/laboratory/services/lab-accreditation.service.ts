...
import { LabComplianceRecord, ComplianceStatus, ComplianceType } from '../entities/lab-compliance-record.entity';
...
export class LabAccreditationService {
    ...
    async createComplianceRecord(accreditationId: string, recordData: Partial<LabComplianceRecord>): Promise<LabComplianceRecord> {
    ...
    private async getComplianceOverview(): Promise<any> {
        ...
        const overallCompliance = complianceRecords.length > 0 
